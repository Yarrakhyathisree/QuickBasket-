...
function switchfordata(x) {
  switch (x) {
    ...
    case "EGGS":
      ...
      break;
    case "AVACADO":
        localStorage.setItem(24, "AVACADO");
        break;
        case "BEETROOTS":
            localStorage.setItem(24, "BEETROOTS");
            break;
      
        case "BIGONION":
            localStorage.setItem(24, "BIGONION");
            break;
        case "BLACKGRAPES":
            localStorage.setItem(24, "BLACKGRAPES");
            break;
        case "BLACKRASPBERRY":
            localStorage.setItem(24, "BLACKRASPBERRY");
            break;
        case "BLUEBERRY":
            localStorage.setItem(24, "BLUEBERRY");
            break;
        case "BUNS":
            localStorage.setItem(24, "BUNS");
            break;
        case "BUTTERCUBES":
            localStorage.setItem(24, "BUTTERCUBES");
            break;
        case "CABBAGE":
            localStorage.setItem(24, "CABBAGE");
            break;
        case "CERMAI":
            localStorage.setItem(24, "CERMAI");
            break;

        case "CHERRY":
            localStorage.setItem(24, "CHERRY");
            break;
        
        case "CHICKENDRUMSTICKS":
                localStorage.setItem(24, "CHICKENDRUMSTICKS");
                break;
    
        case "COCONUT":
                localStorage.setItem(24, "COCONUT");
                break;
    
        case "CONDENSEDMILK":
                localStorage.setItem(24, "CONDENSEDMILK");
                break;
        
        case "CORIANDER":
              localStorage.setItem(24, "CORIANDER");
               break;
        
        case "CORN":
                localStorage.setItem(24, "CORN");
                break;
        case "CRABSS":
                localStorage.setItem(24, "CRABSS");
                break;
        case "CUCUMBER":
                localStorage.setItem(24, "CUCUMBER");
                break;
        case "CURRYLEAVES":
                localStorage.setItem(24, "CURRYLEAVES");
                break;
        case "CUTTEDFISH":
                localStorage.setItem(24, "CUTTEDFISH");
                break;
        
        case "DRAGON":
                localStorage.setItem(24, "DRAGON");
                break;
        
        case "GARLIC":
                    localStorage.setItem(24, "GARLIC");
                    break;
                              
      
     case "GHEE":
                    localStorage.setItem(24, "GHEE");
                        break;
    
        case "GINGER":
                    localStorage.setItem(24, "GINGER");
                     break;
            
        case "GREENCAPSICUM":
                    localStorage.setItem(24, "GREENCAPSICUM");
                    break;
        
        case "GREENCHILLI":
                    localStorage.setItem(24, "GREENCHILLI");
                    break;
            

        case "GREENGRAPES":
                localStorage.setItem(24, "GREENGRAPES");
                break;
        case "GROUNDNUT":
                localStorage.setItem(24, "GROUNDNUT");
                break;
        case "GUAVA":
                localStorage.setItem(24, "GUAVA");
                break;
        
        case "KIWI":
                localStorage.setItem(24, "KIWI");
                break;
            
        case "LEMON":
                localStorage.setItem(24, "LEMON");
                break;
        case "LYCHEE":
                localStorage.setItem(24, "LYCHEE");
                break;
        case "LYCHEE":
                localStorage.setItem(24, "LYCHEE");
                break;
        ...
        case "MUSHROOM":
                localStorage.setItem(24, "MUSHROOM");
                break;
        case "MUSKMELON":
                localStorage.setItem(24, "MUSKMELON");
                break;
        
        case "OKRA":
                localStorage.setItem(24, "OKRA");
                break;
        case "PAPAYA":
                localStorage.setItem(24, "PAPAYA");
                break;
        case "PEACH":
                localStorage.setItem(24, "PEACH");
                break;

        case "POMEGRANATE":
                localStorage.setItem(24, "POMEGRANATE");
                break;
        case "PRAWNS":
                localStorage.setItem(24, "PRAWNS");
                break;
        case "PUMPKIN":
                localStorage.setItem(24, "PUMPKIN");
                break;
        case "RASPBERRIES":
                    localStorage.setItem(24, "RASPBERRIES");
                    break;
        case "REDCARROTS":
                        localStorage.setItem(24, "REDCARROTS");
                        break;
        case "REDCHILLI":
                            localStorage.setItem(24, "REDCHILLI");
                            break;
        case "SEEDLESSGRAPES":
                                localStorage.setItem(24, "SEEDLESSGRAPES");
                                break;
        case "SKIMMEDMILK":
                                    localStorage.setItem(24, "SKIMMEDMILK");
                                    break;
        case "SOFTCHEESE":
                                        localStorage.setItem(24, "SOFTCHEESE");
                                        break;
        
                
        case "SPINACH":
                                localStorage.setItem(24, "SPINACH");
                                            break;
            
        case "STRAWBERRY":
                                localStorage.setItem(24, "STRAWBERRY");
                                                break;
                
        case "SUGARAPPLE":
                                                    localStorage.setItem(24, "SUGARAPPLE");
                                                    break;
        ...
        case "SWISSCHEESE":
                                                            localStorage.setItem(24, "SWISSCHEESE");
                                                            break;
        case "TAMARIND":
                                                                localStorage.setItem(24, "TAMARIND");
                                                                break;
        case "WHEATBREAD":
                                                                    localStorage.setItem(24, "WHEATBREAD");
                                                                    break;
                             
         case "YELLOWCAPSICUM":
                                                                        localStorage.setItem(24, "YELLOWCAPSICUM");
                                                                        break;
